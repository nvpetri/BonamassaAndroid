...
@Composable
fun BonamassaTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = darkColorScheme(
            primary = Brand.Red, onPrimary = Brand.Background, primaryContainer = Brand.Button, onPrimaryContainer = Brand.Cream,
            secondary = Brand.Gold, onSecondary = Brand.Background, background = Brand.Background, onBackground = Brand.Cream,
            surface = Brand.Surface, onSurface = Brand.Cream, surfaceVariant = Brand.Raised, onSurfaceVariant = Brand.Muted,
            outline = Brand.Border, error = Color(0xFFFFB4AB)
        ),
        typography = Typography(
            displaySmall = TextStyle(fontFamily = FontFamily.Serif, fontWeight = FontWeight.Bold, fontSize = 38.sp, lineHeight = 43.sp),
