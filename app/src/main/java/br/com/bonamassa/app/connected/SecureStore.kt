...
import br.com.bonamassa.client.SavedCodec
import br.com.bonamassa.client.SavedState
import java.io.File
...
/** A single encrypted transaction contains the token, cart and original pending write. */
class SecureStore(context: Context) {
    private val file = AtomicFile(File(context.noBackupFilesDir, "customer-api-v1.bin"))
    private val alias = "bonamassa.customer.api.v1"
